  ...
  return (
    <div
      className={`bg-white text-black font-sans ${
        mode === MODES.WALKTHROUGH ? "h-screen overflow-hidden" : "min-h-screen"
      }`}
    >
      {mode !== MODES.WALKTHROUGH && <CoverPage show={show} setShow={setShow} mode={mode} />}
        ...
        <>
          ...
          <div className="p-4 pb-0">
            ...
            <div className="flex justify-around m-4 text-center">
              ...
              <Link to={`/tutorial/UPI/Bank/options/${mode}`}>
                <div className="flex flex-col items-center">
                  <div
                    className="w-12 h-12 bg-[#6510C5] rounded-full flex justify-center items-end overflow-hidden text-[40px] text-[#E1CEFC]"
                    ref={BankButtonRef}
                  >
          ...
          <div className="p-4 grid grid-cols-2 gap-4">
            ...
            <div className="p-4 pb-0 bg-white text-black rounded-lg flex flex-col shadow-lg col-span-1 row-span-2 justify-between">
              ...
              <div className="rounded-lg flex justify-end translate-x-4">
                <img src="/assets/Tutorials/UPI/QRPayments/bills.png" alt="" />
              </div>
            </div>
            {/* Travel & stays */}
