...
function Dashboard({ mode }) {
  ...
  const mobilecontact = useRef(null);
  ...
  return (
    ...
    >
      {mode !== MODES.WALKTHROUGH && (
        <CoverPage show={show} setShow={setShow} mode={mode} />
      )}
      ...
      {mode === MODES.PRACTICE && (
        <PracticeOverlay step="UPI_Mobile_landing" refs={{ mobilecontact }} />
      )}
        ...
        <div className="bg-white min-h-screen text-black font-sans">
          ...
          <div className="p-4 pb-0">
            ...
            <div className="flex justify-around m-4 text-center">
              <Link to={`/tutorial/UPI/Mobile/to-contact/${mode}`}>
                <div className="flex flex-col items-center cursor-pointer">
                  <div
                    className="w-12 h-12 bg-[#6510C5] rounded-full flex justify-center items-end overflow-hidden"
                    ref={mobilecontact}
                  >
