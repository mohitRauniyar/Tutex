...
export default function CourseBanner({ imageLink, title, lessonCount }) {
  return (
    <Link to="/tutorial/UPI" className="w-40 h-68 block">
      <div
      ...
      >
        <div className="relative text-white w-full h-full bg-gradient-to-b from-[#00000076] to-gray-950 to-80% rounded-lg p-4 gap-2 flex flex-col justify-end">
          ...
          <p className="text-sm font-light">Lessons: {lessonCount}</p>
        </div>
      </div>
    </Link>
  );
